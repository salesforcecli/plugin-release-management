...
import CircelCIEnvvarUpdate, {
  CircelCIEnvvarUpdateStatus,
  EnvvarUpdateStatus,
} from '../../src/commands/circleci/envvar/update';
...
function expectSlugStatus(slugs: string[], result: CircelCIEnvvarUpdateStatus) {
  ...
  const matchedUpdates = updatedSlugs.filter((repo) => {
    ...
    const updateStatus = result[repo] as EnvvarUpdateStatus[];
...
describe('circleci envvar update', () => {
  ...
  test
    .stub(CircelCIEnvvarUpdate.prototype, 'isPipedIn', async () => true)
    .stub(CircelCIEnvvarUpdate.prototype, 'readPipedInput', async () => 'gh/salesforcecli/plugin-auth')
    .stub(got, 'get', () => Promise.resolve({ body: '{ "items": [{ "name": "MYENVVAR" }] }' }))
    .stub(got, 'delete', () => Promise.resolve())
    .stub(got, 'post', () => Promise.resolve())
    .stdout()
  ...
  test
    .stub(env, 'getString', () => FAKE_ENVVAR_VALUE)
    .stub(CircelCIEnvvarUpdate.prototype, 'isPipedIn', async () => true)
    .stub(CircelCIEnvvarUpdate.prototype, 'readPipedInput', async () => '{ "result": ["gh/salesforcecli/plugin-auth"]}')
    .stub(got, 'get', () => Promise.resolve({ body: '{ "items": [{ "name": "MYENVVAR" }] }' }))
    .stub(got, 'delete', () => Promise.resolve())
    .stub(got, 'post', () => Promise.resolve())
    .stdout()
  ...
  test
    ...
    .stub(CircelCIEnvvarUpdate.prototype, 'isPipedIn', async () => true)
    .stub(
      CircelCIEnvvarUpdate.prototype,
      'readPipedInput',
